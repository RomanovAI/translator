...
class NetworkService {
    ...
    func request(urlString: String, requestModel: RequestModel, completion: @escaping (Data?, Error?) -> Void) {
...
//        request.allHTTPHeaderFields = headers
    ...
    private func createDataTask(request: URLRequest, completion: @escaping (Data?, Error?) -> Void) -> URLSessionTask {
